    ...
    >
      ...
      >
          ...
          <ScrollArea className='flex-1'>
            <div className='p-4 space-y-3'>
              ...
              >
                ...
                >
                  <path
                    d='M10.5 1.5H3.75A2.25 2.25 0 001.5 3.75v12.5A2.25 2.25 0 003.75 18.5h12.5a2.25 2.25 0 002.25-2.25V9.5M10.5 1.5v4M10.5 1.5L19.5 10.5M10.5 5.5h4M4 11.5h8M4 14.5h6'
                    stroke='currentColor'
                    strokeWidth='1.5'
                    fill='none'
                  />
        ...
        <ResizablePanel className='flex-1 flex flex-col bg-linear-to-br from-gray-100 to-gray-200'>
          ...
          {/* A4 Preview Area */}
          <div
            className='flex-1 overflow-auto bg-[#eaedee]'
                          ...
                          return (
                            ...
                            >
                              ...
                              >
                                <TemplateComponent
                                  employee={employee}
                                  options={{ width: '92mm', height: '57.94mm' }}
                                />
                              </div>
                            </div>
                          );
